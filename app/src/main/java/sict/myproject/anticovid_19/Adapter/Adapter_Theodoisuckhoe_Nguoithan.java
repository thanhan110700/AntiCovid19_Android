...
public class Adapter_Theodoisuckhoe_Nguoithan extends RecyclerView.Adapter<Adapter_Theodoisuckhoe_Nguoithan.ViewHolder> {

    Context context;
    ArrayList<Theodoisuckhoe> theodoisuckhoeArrayList;

    public Adapter_Theodoisuckhoe_Nguoithan(Context context, ArrayList<Theodoisuckhoe> theodoisuckhoeArrayList) {
